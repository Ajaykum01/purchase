...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("👉 How To Download 👈", url=f"https://t.me/kpslinkteam/13")
    ])
    try:
    ...
    if query.data.startswith("file"):
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              ...
                              InlineKeyboardButton('Backup Channel ✅',url='https://t.me/+u7wOJcLYKA80NzQ1')
                             ]
                            ]
                        )
                    )
        ...
        await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  InlineKeyboardButton('𝐉𝐨𝐢𝐧 𝐅𝐨𝐫 𝐌𝐨𝐫𝐞 🎬', url='https://telegram.me/+pihWAHWUSMFkZmNl')
                 ]
                ]
            )
        )
